...
function AnimatedGlobe() {
  return (
    <div className="relative w-32 h-32 mx-auto mb-8">
      ...
      <Leaf className="absoulte inset-0 m-auto h-16 w-16 text-green-600 animate-pulse"/>
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        ...
        icon={Coins}
        title="Earn Rewards"
        description="we are committed to reeducing waste and promoting sustainability"
        />
         <FeatureCard 
        icon={Leaf}
